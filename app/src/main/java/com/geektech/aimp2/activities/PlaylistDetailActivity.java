...
import com.geektech.aimp2.adapters.SongsListAdapter;
...
import com.geektech.aimp2.dataloaders.LastAddedLoader;
import com.geektech.aimp2.dataloaders.PlaylistLoader;
import com.geektech.aimp2.dataloaders.PlaylistSongLoader;
import com.geektech.aimp2.dataloaders.SongLoader;
import com.geektech.aimp2.dataloaders.TopTracksLoader;
...
import com.geektech.aimp2.widgets.DragSortRecycler;
...
public class PlaylistDetailActivity extends BaseActivity implements ATEActivityThemeCustomizer, ATEToolbarCustomizer {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        if (action.equals(Constants.NAVIGATE_PLAYLIST_USERCREATED)) {
            ...
            menu.findItem(R.id.action_clear_auto_playlist).setTitle(R.string.clear + " " + playlistname.getText().toString());
        }
    ...
    private void showDeletePlaylistDialog() {
        new MaterialDialog.Builder(this)
                ...
                .content(getString(R.string.sure_delete_playlist) + " " + playlistname.getText().toString() + " ?")
