...
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (action != null && action.equals("restore")) {
            status.setText(R.string.restoring_purchases);
        }
    ...
    public void onProductPurchased(String productId, TransactionDetails details) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(DonateActivity.this, R.string.thanks_for_your_support, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onBillingError(int errorCode, Throwable error) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(DonateActivity.this, R.string.unable_to_process_purchase, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean b) {
                ...
                if (b) {
                    ...
                    status.setText(getString(R.string.thanks_for_your_support));
                    if (action!=null && action.equals("restore")) {
                        status.setText(R.string.purchases_restored);
                    ...
                    if (action!=null && action.equals("restore")) {
                        status.setText(R.string.no_purchase);
                        getProducts();
                    }
                }
            }
                    ...
                    rootView.findViewById(R.id.btn_donate).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (readyToPurchase)
                                ...
                                Toast.makeText(DonateActivity.this, R.string.unable_to_initiate_purchase, Toast.LENGTH_SHORT).show();
                        }
                    });
