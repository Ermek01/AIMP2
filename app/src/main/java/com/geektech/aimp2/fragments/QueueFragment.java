...
import com.geektech.aimp2.adapters.PlayingQueueAdapter;
...
public class QueueFragment extends Fragment implements MusicStateListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView.setEmptyView(getActivity(), rootView.findViewById(R.id.list_empty), getString(R.string.no_songs_in_queue));
