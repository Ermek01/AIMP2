...
public class AIMPApp extends MultiDexApplication {


    private static AIMPApp mInstance;

    public static synchronized AIMPApp getInstance() {
        return mInstance;
    }
    ...
    public void onCreate() {
        ...
        ImageLoaderConfiguration localImageLoaderConfiguration = new ImageLoaderConfiguration.Builder(this).imageDownloader(new BaseImageDownloader(this) {
            PreferencesUtility prefs = PreferencesUtility.getInstance(AIMPApp.this);
