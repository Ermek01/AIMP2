...
import com.geektech.aimp2.activities.DonateActivity;
...
public class SubStyleSelectorFragment extends Fragment {
    ...
    private void showPurchaseDialog() {
        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                ...
                .content(R.string.style_purchase)
                .positiveText(R.string.support_development)
                .neutralText(R.string.restore_purchases)
                .onPositive(new MaterialDialog.SingleButtonCallback() {
                    ...
                    public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                        ...
                        intent.putExtra("title", R.string.restoring_purchases);
